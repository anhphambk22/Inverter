// Edited by: NGUYEN VAN MINH TAM
//Board : DSP28377DxEVtechVER2
// Included Files
////
...
//    GpioCtrlRegs.GPFPUD.bit.GPIO162 = 1;    // Disable pull-up on GPIO162 (EPWM9B)
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO16 = 1;   // Configure GPIO14 as EPWM8A
	GpioCtrlRegs.GPAGMUX2.bit.GPIO17 = 1;   // Configure GPIO15 as EPWM8B
...
void InitEPwm10Gpio(void)
{
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO18 = 1;    // Disable pull-up on GPIO163 (EPWM10A)
       ...
       GpioCtrlRegs.GPAGMUX2.bit.GPIO18 = 1;   // Configure GPIO14 as EPWM9A
       GpioCtrlRegs.GPAGMUX2.bit.GPIO19 = 1;   // Configure GPIO15 as EPWM9B
...
void InitEPwm11Gpio(void)
{
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;    // Disable pull-up on GPIO165 (EPWM11A)
       ...
       GpioCtrlRegs.GPAGMUX2.bit.GPIO20 = 1;   // Configure GPIO14 as EPWM9A
       GpioCtrlRegs.GPAGMUX2.bit.GPIO21 = 1;   // Configure GPIO15 as EPWM9B
...
void InitEPwm12Gpio(void)
{
    ...
    GpioCtrlRegs.GPAGMUX2.bit.GPIO22 = 1;   // Configure GPIO14 as EPWM11A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO23 = 1;   // Configure GPIO15 as EPWM11B
